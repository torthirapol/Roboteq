...
//   void odom_publish();
// #ifdef _ODOM_COVAR_SERVER
//   void odom_covar_callback(const roboteq_diff_msgs::msg::RequestOdometryCovariancesRequest& req, roboteq_diff_msgs::msg::RequestOdometryCovariancesResponse& res);
// #endif
...
//   RCLCPP_INFO_STREAM("Subscribing to topic " << cmdvel_topic);
...
//       cmdvel_topic, 1000, std::bind(&MainNode::cmdvel_callback));
// }
...
// #ifdef _ODOM_COVAR_SERVER
// void MainNode::odom_covar_callback(const roboteq_diff_msgs::msg::RequestOdometryCovariancesRequest& req, roboteq_diff_msgs::msg::RequestOdometryCovariancesResponse& res)
// {
...
//   if ( pub_odom_tf )
//   {
//     RCLCPP_INFO("Broadcasting odom tf");
// //    odom_broadcaster.init(nh);	// ???
//   }

//   RCLCPP_INFO_STREAM("Publishing to topic " << odom_topic);
...
// #ifdef _ODOM_DEBUG
// RCLCPP_DEBUG_STREAM("encoder right: " << odom_encoder_right << " left: " << odom_encoder_left);
// #endif
//             odom_publish();
//             break;
//           }
...
//   geometry_msgs::msg::Quaternion quat = tf::createQuaternionMsgFromYaw(odom_yaw);

//   if ( pub_odom_tf )
//   {
//     tf_msg.header.seq++;
//     tf_msg.header.stamp = rclcpp::Time now()= this->get_clock_now();
...
//   odom_msg.header.seq++;
//   odom_msg.header.stamp = rclcpp::Time::now();
...
// 	while ( rclcpp::ok() )
// 	{
// 		RCLCPP_INFO_STREAM("Opening serial port on " << port << " at " << baud << "..." );
// 		try
// 		{
// 			controller.open();
// 			if ( controller.isOpen() )
// 			{
// 				RCLCPP_INFO("Successfully opened serial port");
// 				break;
// 			}
// 		}
// 		catch (serial::IOException e)
// 		{
// 			RCLCPP_WARN_STREAM("serial::IOException: " << e.what());
// 		}
// 		RCLCPP_WARN("Failed to open serial port");
// 		sleep( 5 );
// 	}
...
//   rclcpp::init(argc, argv, "main_node");
